#!/bin/bash
### BEGIN INIT INFO
# Provides:          cnosdb-meta
# Required-Start:    $all
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Start the CnosDB Meta process
### END INIT INFO

# If you modify this, please make sure to also edit cnosdb-meta.service

# Command-line options that can be set in /etc/default/cnosdb-meta.  These will override
...
# Configuration file
CONFIG=/etc/cnosdb/cnosdb-meta.conf
