...
func (cmd *cobra.Command) planToSpec(p *generate.SchemaPlan) *gen.Spec {
...
func (cmd *cobra.Command) exec(storagePlan *generate.StoragePlan, spec *gen.Spec) error {
...
func (cmd *cobra.Command) printExample() error {
