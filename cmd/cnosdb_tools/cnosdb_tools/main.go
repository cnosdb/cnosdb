...
import (
	...
	"github.com/cnosdb/cnosdb/cmd"
	"github.com/cnosdb/cnosdb/cmd/cnosdb_tools/compact"
	"github.com/cnosdb/cnosdb/cmd/cnosdb_tools/export"
	genexec "github.com/cnosdb/cnosdb/cmd/cnosdb_tools/generate/exec"
	geninit "github.com/cnosdb/cnosdb/cmd/cnosdb_tools/generate/init"
	"github.com/cnosdb/cnosdb/cmd/cnosdb_tools/help"
	"github.com/cnosdb/cnosdb/cmd/cnosdb_tools/importer"
...
func (m *Main) Run(args ...string) error {
	...
	default:
		return fmt.Errorf(`unknown command "%s"`+"\n"+`Run 'cnosdb-tools help' for usage`+"\n\n", name)
	}
...
func (s *ossServer) resolvePath(path string) string {
	...
	for _, p := range []string{
		os.ExpandEnv("${HOME}/.cnosdb/cnosdb.conf"),
