...
func (cmd *cobra.Command) Run(args ...string) error {
...
func (cmd *cobra.Command) run() error {
...
func (cmd *cobra.Command) readFileSet(sfile *tsdb.SeriesFile) (*tsi1.Index, *tsi1.FileSet, error) {
...
func (cmd *cobra.Command) printSeries(sfile *tsdb.SeriesFile) error {
	if !cmd.showSeries {
		return nil
	}
...
func (cmd *cobra.Command) printMeasurements(sfile *tsdb.SeriesFile, fs *tsi1.FileSet) error {
...
func (cmd *cobra.Command) printTagKeys(sfile *tsdb.SeriesFile, fs *tsi1.FileSet, name []byte) error {
	if !cmd.showTagKeys {
		return nil
	}
...
func (cmd *cobra.Command) printTagValues(sfile *tsdb.SeriesFile, fs *tsi1.FileSet, name, key []byte) error {
	if !cmd.showTagValues {
		return nil
	}
...
func (cmd *cobra.Command) printTagValueSeries(sfile *tsdb.SeriesFile, fs *tsi1.FileSet, name, key, value []byte) error {
	if !cmd.showTagValueSeries {
		return nil
	}
...
func (cmd *cobra.Command) printFileSummaries(fs *tsi1.FileSet) error {
...
func (cmd *cobra.Command) printLogFileSummary(f *tsi1.LogFile) error {
...
func (cmd *cobra.Command) printIndexFileSummary(f *tsi1.IndexFile) error {
...
func (cmd *cobra.Command) matchSeries(name []byte, tags models.Tags) bool {
...
func (cmd *cobra.Command) printUsage() {
