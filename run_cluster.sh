...
nohup ./target/debug/cnosdb run --config ./config/config_31001.toml > /tmp/cnosdb/logs/data_node.1001.log 2>&1 &

sleep 1

echo "*** start CnosDB server 32001......"
nohup ./target/debug/cnosdb run --config ./config/config_32001.toml > /tmp/cnosdb/logs/data_node.2001.log 2>&1 &
