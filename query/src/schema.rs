...
use protos::schema_service::{Column, Table};
...
impl From<ColumnType> for ArrowDataType {
    fn from(t: ColumnType) -> Self {
        match t {
            ColumnType::F64 => Self::Float64,
            ColumnType::I64 => Self::Int64,
            ColumnType::U64 => Self::UInt64,
            ColumnType::String => Self::Utf8,
...
impl TryFrom<ArrowDataType> for ColumnType {
    ...
    fn try_from(value: ArrowDataType) -> Result<Self, Self::Error> {
        match value {
            ...
            _ => Err("Error datatype not supported"),
        }
    }
}
