...
pub struct StorageConfig {
    ...
    #[serde(
        with = "bytes_num",
        default = "StorageConfig::default_max_data_block_cache_size"
    )]
    pub max_data_block_cache_size: u64,
...
impl StorageConfig {
    ...
    fn default_max_data_block_cache_size() -> u64 {
        // 512MB
        512 * 1024 * 1024
    }
...
impl Default for StorageConfig {
    fn default() -> Self {
        Self {
            ...
            max_data_block_cache_size: Self::default_max_data_block_cache_size(),
