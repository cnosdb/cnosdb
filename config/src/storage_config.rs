...
pub struct StorageConfig {
    ...
    #[serde(with = "bytes_num", default = "StorageConfig::default_reserver_space")]
    pub reserver_space: u64,
}
...
impl Default for StorageConfig {
    fn default() -> Self {
        Self {
            ...
            reserver_space: Self::default_reserver_space(),
        }
    }
}
