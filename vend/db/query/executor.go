...
type CoarseAuthorizer interface {
	...
	AuthorizeDatabase(p cnosql.Privilege, name string) bool
}

type openCoarseAuthorizer struct{}

func (a openCoarseAuthorizer) AuthorizeDatabase(cnosql.Privilege, string) bool { return true }
...
func (a openAuthorizer) AuthorizeQuery(_ string, _ *cnosql.Query) error { return nil }
