...
import (
	...
	internal "github.com/cnosdb/cnosdb/vend/db/query/internal"
...
func NewReaderIterator(ctx context.Context, r io.Reader, typ cnosql.DataType, stats IteratorStats) Iterator {
	switch typ {
	case cnosql.Float:
