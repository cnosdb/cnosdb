...
func TestScanner_Scan(t *testing.T) {
	var tests = []struct {
		...
		{s: `METRIC`, tok: cnosql.METRIC},
		{s: `METRICS`, tok: cnosql.METRICS},
		...
		{s: `REGION`, tok: cnosql.REGION},
		{s: `REGIONS`, tok: cnosql.REGIONS},
		...
		{s: `TO`, tok: cnosql.TO},
		{s: `TTL`, tok: cnosql.TTLS},
		{s: `TTLS`, tok: cnosql.TTLS},
