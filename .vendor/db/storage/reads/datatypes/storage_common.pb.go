...
type ReadGroupRequest struct {
	...
	Group     ReadGroupRequest_Group `protobuf:"varint,5,opt,name=group,proto3,enum=cnosdata.platform.storage.ReadGroupRequest_Group" json:"group,omitempty"`
...
type Aggregate struct {
	Type Aggregate_AggregateType `protobuf:"varint,1,opt,name=type,proto3,enum=cnosdata.platform.storage.Aggregate_AggregateType" json:"type,omitempty"`
}
...
type ReadResponse_SeriesFrame struct {
	...
	DataType ReadResponse_DataType `protobuf:"varint,2,opt,name=data_type,json=dataType,proto3,enum=cnosdata.platform.storage.ReadResponse_DataType" json:"data_type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("cnosdata.platform.storage.ReadGroupRequest_Group", ReadGroupRequest_Group_name, ReadGroupRequest_Group_value)
	proto.RegisterEnum("cnosdata.platform.storage.ReadGroupRequest_HintFlags", ReadGroupRequest_HintFlags_name, ReadGroupRequest_HintFlags_value)
	proto.RegisterEnum("cnosdata.platform.storage.Aggregate_AggregateType", Aggregate_AggregateType_name, Aggregate_AggregateType_value)
	proto.RegisterEnum("cnosdata.platform.storage.ReadResponse_FrameType", ReadResponse_FrameType_name, ReadResponse_FrameType_value)
	proto.RegisterEnum("cnosdata.platform.storage.ReadResponse_DataType", ReadResponse_DataType_name, ReadResponse_DataType_value)
	proto.RegisterType((*ReadFilterRequest)(nil), "cnosdata.platform.storage.ReadFilterRequest")
	proto.RegisterType((*ReadGroupRequest)(nil), "cnosdata.platform.storage.ReadGroupRequest")
	proto.RegisterType((*Aggregate)(nil), "cnosdata.platform.storage.Aggregate")
	proto.RegisterType((*Tag)(nil), "cnosdata.platform.storage.Tag")
	proto.RegisterType((*ReadResponse)(nil), "cnosdata.platform.storage.ReadResponse")
	proto.RegisterType((*ReadResponse_Frame)(nil), "cnosdata.platform.storage.ReadResponse.Frame")
	proto.RegisterType((*ReadResponse_GroupFrame)(nil), "cnosdata.platform.storage.ReadResponse.GroupFrame")
	proto.RegisterType((*ReadResponse_SeriesFrame)(nil), "cnosdata.platform.storage.ReadResponse.SeriesFrame")
	proto.RegisterType((*ReadResponse_FloatPointsFrame)(nil), "cnosdata.platform.storage.ReadResponse.FloatPointsFrame")
	proto.RegisterType((*ReadResponse_IntegerPointsFrame)(nil), "cnosdata.platform.storage.ReadResponse.IntegerPointsFrame")
	proto.RegisterType((*ReadResponse_UnsignedPointsFrame)(nil), "cnosdata.platform.storage.ReadResponse.UnsignedPointsFrame")
	proto.RegisterType((*ReadResponse_BooleanPointsFrame)(nil), "cnosdata.platform.storage.ReadResponse.BooleanPointsFrame")
	proto.RegisterType((*ReadResponse_StringPointsFrame)(nil), "cnosdata.platform.storage.ReadResponse.StringPointsFrame")
	proto.RegisterType((*CapabilitiesResponse)(nil), "cnosdata.platform.storage.CapabilitiesResponse")
	proto.RegisterMapType((map[string]string)(nil), "cnosdata.platform.storage.CapabilitiesResponse.CapsEntry")
	proto.RegisterType((*TimestampRange)(nil), "cnosdata.platform.storage.TimestampRange")
	proto.RegisterType((*TagKeysRequest)(nil), "cnosdata.platform.storage.TagKeysRequest")
	proto.RegisterType((*TagValuesRequest)(nil), "cnosdata.platform.storage.TagValuesRequest")
	proto.RegisterType((*StringValuesResponse)(nil), "cnosdata.platform.storage.StringValuesResponse")
}
...
func (c *storageClient) ReadFilter(ctx context.Context, in *ReadFilterRequest, opts ...grpc.CallOption) (Storage_ReadFilterClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Storage_serviceDesc.Streams[0], "/cnosdata.platform.storage.Storage/ReadFilter", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *storageClient) ReadGroup(ctx context.Context, in *ReadGroupRequest, opts ...grpc.CallOption) (Storage_ReadGroupClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Storage_serviceDesc.Streams[1], "/cnosdata.platform.storage.Storage/ReadGroup", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *storageClient) TagKeys(ctx context.Context, in *TagKeysRequest, opts ...grpc.CallOption) (Storage_TagKeysClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Storage_serviceDesc.Streams[2], "/cnosdata.platform.storage.Storage/TagKeys", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *storageClient) TagValues(ctx context.Context, in *TagValuesRequest, opts ...grpc.CallOption) (Storage_TagValuesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Storage_serviceDesc.Streams[3], "/cnosdata.platform.storage.Storage/TagValues", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *storageClient) Capabilities(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*CapabilitiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cnosdata.platform.storage.Storage/Capabilities", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Storage_Capabilities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cnosdata.platform.storage.Storage/Capabilities",
	}
...
var _Storage_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cnosdata.platform.storage.Storage",
