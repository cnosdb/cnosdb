...
type Node struct {
	NodeType Node_Type `protobuf:"varint,1,opt,name=node_type,json=nodeType,proto3,enum=cnosdata.platform.storage.Node_Type" json:"nodeType"`
...
type Node_Logical_ struct {
	Logical Node_Logical `protobuf:"varint,11,opt,name=logical,proto3,enum=cnosdata.platform.storage.Node_Logical,oneof" json:"logical,omitempty"`
}
type Node_Comparison_ struct {
	Comparison Node_Comparison `protobuf:"varint,12,opt,name=comparison,proto3,enum=cnosdata.platform.storage.Node_Comparison,oneof" json:"comparison,omitempty"`
}
...
func init() {
	proto.RegisterEnum("cnosdata.platform.storage.Node_Type", Node_Type_name, Node_Type_value)
	proto.RegisterEnum("cnosdata.platform.storage.Node_Comparison", Node_Comparison_name, Node_Comparison_value)
	proto.RegisterEnum("cnosdata.platform.storage.Node_Logical", Node_Logical_name, Node_Logical_value)
	proto.RegisterType((*Node)(nil), "cnosdata.platform.storage.Node")
	proto.RegisterType((*Predicate)(nil), "cnosdata.platform.storage.Predicate")
}
