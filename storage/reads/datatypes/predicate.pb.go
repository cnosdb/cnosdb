...
var file_predicate_proto_goTypes = []interface{}{
	(Node_Type)(0),       // 0: cnosdb.platform.storage.Node.Type
	(Node_Comparison)(0), // 1: cnosdb.platform.storage.Node.Comparison
	(Node_Logical)(0),    // 2: cnosdb.platform.storage.Node.Logical
	(*Node)(nil),         // 3: cnosdb.platform.storage.Node
	(*Predicate)(nil),    // 4: cnosdb.platform.storage.Predicate
}
var file_predicate_proto_depIdxs = []int32{
	0, // 0: cnosdb.platform.storage.Node.node_type:type_name -> cnosdb.platform.storage.Node.Type
	3, // 1: cnosdb.platform.storage.Node.children:type_name -> cnosdb.platform.storage.Node
	2, // 2: cnosdb.platform.storage.Node.logical:type_name -> cnosdb.platform.storage.Node.Logical
	1, // 3: cnosdb.platform.storage.Node.comparison:type_name -> cnosdb.platform.storage.Node.Comparison
	3, // 4: cnosdb.platform.storage.Predicate.root:type_name -> cnosdb.platform.storage.Node
