...
fn criterion_benchmark(c: &mut Criterion) {
    let lru = Arc::new(ShardedCache::<i8, Arc<i8>>::with_capacity(128));
    let mut group = c.benchmark_group("bench lru_cache");
    ...
    let lru = Arc::new(lru_cache::asynchronous::ShardedCache::<i8, Arc<i8>>::with_capacity(128));
    let mut group = c.benchmark_group("bench async lru_cache");
