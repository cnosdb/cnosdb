...
nohup ${PROJ_DIR}/target/debug/cnosdb-meta --config ${PROJ_DIR}/meta/config/config_21001.toml > /tmp/cnosdb/logs/meta_node.1.log 2>&1 &
echo "Server 1 started"
sleep 1

nohup ${PROJ_DIR}/target/debug/cnosdb-meta --config ${PROJ_DIR}/meta/config/config_21002.toml > /tmp/cnosdb/logs/meta_node.2.log 2>&1 &
