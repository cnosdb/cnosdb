            ...
            .and_then(
                |req: Bytes,
                 ...
                 host: String| async move {
                    ...
                    metrics.queries_inc(tenant, user, db, host.as_str());
            ...
            .and_then(
                |req: Bytes,
                 ...
                 host: String| async move {
                    ...
                    metrics.writes_inc(tenant, user, db, host.as_str());
            ...
            .and_then(
                |req: Bytes,
                 ...
                 host: String| async move {
                    ...
                    metrics.queries_inc(tenant_name, username, database_name, host.as_str());
