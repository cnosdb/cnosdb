...
use datafusion::arrow::array::{ArrayRef, TimestampNanosecondArray};
...
impl GapFillStream {
    ...
    fn take_buffered_input(&mut self) -> Result<Option<RecordBatch>> {
        ...
        let batch = arrow::compute::concat_batches(&self.schema, &batches)
