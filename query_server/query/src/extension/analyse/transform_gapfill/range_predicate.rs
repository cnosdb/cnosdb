...
use datafusion::logical_expr::{Between, BinaryExpr, LogicalPlan, Operator};
...
mod tests {
    ...
    use datafusion::logical_expr::logical_plan::{self};
    use datafusion::logical_expr::{Between, LogicalPlan, LogicalPlanBuilder};
    use datafusion::prelude::{col, lit, lit_timestamp_nano, Column, Expr, Partitioning};
